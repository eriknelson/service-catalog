...
func getTestServiceBrokerWithStatus(status v1beta1.ConditionStatus) *v1beta1.ServiceBroker {
...
func getTestServiceBrokerWithStatusAndTime(status v1beta1.ConditionStatus, lastTransitionTime, lastRelistTime metav1.Time) *v1beta1.ServiceBroker {
	broker := getTestServiceBroker()
	broker.Status = v1beta1.ServiceBrokerStatus{
		CommonServiceBrokerStatus: v1beta1.CommonServiceBrokerStatus{
			Conditions: []v1beta1.ServiceBrokerCondition{{
