...
func autoConvert_v1alpha1_ServiceBrokerList_To_servicecatalog_ServiceBrokerList(in *ServiceBrokerList, out *servicecatalog.ServiceBrokerList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]servicecatalog.ServiceBroker, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_ServiceBroker_To_servicecatalog_ServiceBroker(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_servicecatalog_ServiceBrokerList_To_v1alpha1_ServiceBrokerList(in *servicecatalog.ServiceBrokerList, out *ServiceBrokerList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]ServiceBroker, len(*in))
		for i := range *in {
			if err := Convert_servicecatalog_ServiceBroker_To_v1alpha1_ServiceBroker(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_servicecatalog_ServiceBrokerSpec_To_v1alpha1_ServiceBrokerSpec(in *servicecatalog.ServiceBrokerSpec, out *ServiceBrokerSpec, s conversion.Scope) error {
	...
	out.InsecureSkipTLSVerify = in.InsecureSkipTLSVerify
	out.CABundle = *(*[]byte)(unsafe.Pointer(&in.CABundle))
	// WARNING: in.SyncBehavior requires manual conversion: does not exist in peer-type
	// WARNING: in.SyncDuration requires manual conversion: does not exist in peer-type
	// WARNING: in.RelistRequests requires manual conversion: does not exist in peer-type
	return nil
}
